@props(['label', 'value', 'icon' => 'icon-wallet.svg', 'tone' => 'emerald', 'hint' => null])
...
<x-card class="h-full p-4">
    <div class="flex min-w-0 items-center gap-3">
        ...
        <div class="min-w-0">
            ...
            <div class="mt-1 break-words text-lg font-extrabold leading-tight tracking-tight text-slate-950 xl:text-xl">
                {{ $value }}</div>
            @if ($hint)
